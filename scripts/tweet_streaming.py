...
class StreamWatcherListener(tweepy.StreamListener):
    ...
    def __init__(self, dir_dest, prefix, ext, auth):
        ...
        if head:
            self.f_out.write(
                'id tweet\tdate\tauthor\ttext\tapp\tid user\tfollowers\tfollowing\tstauses\tlocation\turls\tgeolocation\tname\tdescription\turl_media\ttype media\tquoted\trelation\treplied_id\tuser replied\tretweeted_id\tuser retweeted\tquoted_id\tuser quoted\tfirst HT\tlang\tlink\n')
                ...
                if 'quoted_status' in statuse:
                    ...
                    if 'quoted_status' in statuse['retweeted_status']:
                        ...
                        if 'extended_tweet' in statuse['retweeted_status']['quoted_status']:
                            statuse_quoted_text = statuse['retweeted_status']['quoted_status']['extended_tweet'][
                                'full_text']
                        statuse_quoted_text = re.sub('[\r\n\t]+', ' ', statuse_quoted_text)
            except:
